# backend/services/service_cover_letter/src/api/routes/routes_corrections.py
...
def get_correction_service(db: Session = Depends(PostgresConnection.get_db)) -> CorrectionService:
