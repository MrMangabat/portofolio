# backend/services/service_cover_letter/src/data_repositories/postgres_repository.py
"""Postgres CRUD functionality"""

from sqlalchemy.orm import Session
from src.data_models.databases.postgres.postgres_models import CorrectionORM, CorrectionType, JobListingORM, JobListingItem
